...
<div class="col-sm-8 blog-main">
    ...
    <div class="blog-post">
        ...
        <form class="form-horizontal" action="index.php?pageid=4" method="post">
            ...
            <div class="form-group">
                <label for="inputPassword1" class="col-sm-4 control-label">Wachtwoord</label>
                <div class="col-sm-8">
        ...
        <p><a href="index.php?pageid=9&option=1">Gebruikersnaam vergeten?</a> -
            <a href="index.php?pageid=9&option=2">Wachtwoord vergeten?</a> -
            <a href="index.php?pageid=9&option=3">Gebruikersnaam & wachtwoord vergeten</a></p>
